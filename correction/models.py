...
class Student(models.Model):
    ...
    id_class = models.ForeignKey(
        Turma, on_delete=models.CASCADE, related_name="students"
    )
...
class Activity(models.Model):
    ...
    id_class = models.ForeignKey(
        Turma, on_delete=models.CASCADE, related_name="activities"
    )


class Answer(models.Model):
    id_activity = models.ForeignKey(
        Activity, on_delete=models.CASCADE, related_name="answers"
    )
